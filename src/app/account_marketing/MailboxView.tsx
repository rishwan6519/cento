    ...
    <div className="pb-12 max-w-[800px] mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
        <div>
          ...
          <input type="text" placeholder="store-user@example.com" className="w-full p-3 border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#FF5722]/50" />
        </div>
        <div>
          <label className="block text-sm font-bold text-gray-700 mb-2">Subject</label>
          <input type="text" placeholder="Requesting Campaign Status" className="w-full p-3 border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#FF5722]/50" />
        </div>
        <div>
