            ...
            <div className="p-8 text-center">
              ...
              {scanActive ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h2 className="text-2xl font-semibold">Device Found</h2>
                  <p className="text-gray-600 mt-2">
                    The device has been successfully detected by the barcode. Click to proceed.
                  </p>
                  <button
                ...
                <div className="text-center py-8">
                  <RingLoader size={60} color="#4F46E5" />
                  <p className="mt-4 text-lg font-medium">Scanning for Barcode...</p>
                </div>
              )}
            </div>
          </div>
