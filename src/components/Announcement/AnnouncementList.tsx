...
// //   // --- View Mode ---
// //   const [viewMode, setViewMode] = useState<'list' | 'grid' | 'table'>('table'); // default table
...
// //               className={`p-2 rounded border ${viewMode === 'list' ? 'bg-blue-500 text-white' : 'bg-gray-100'}`}
// //             >
// //               List
// //             </button>
// //             <button
// //               onClick={() => setViewMode('grid')}
// //               className={`p-2 rounded border ${viewMode === 'grid' ? 'bg-blue-500 text-white' : 'bg-gray-100'}`}
// //             >
// //               Grid
// //             </button>
// //             <button
// //               onClick={() => setViewMode('table')}
// //               className={`p-2 rounded border ${viewMode === 'table' ? 'bg-blue-500 text-white' : 'bg-gray-100'}`}
// //             >
// //               Table
// //             </button>
// //           </div>
...
// //       {/* --- Table View --- */}
// //       {viewMode === 'table' && playlists.length > 0 && (
...
// //                 <td className="px-4 py-3 font-medium flex items-center gap-2"><span
...
// //               </span>
// //             </td>
// //                 {/* <td className="px-4 py-2">{playlist.announcements.length}</td> */}
...
// //   aria-label="Edit playlist"> <Edit size={18} color="#FF4500" /></button>
...
// //                   >
// //                     <Trash2 size={16} color="#FF4500" /></button>
// //                 </td>
// //               </tr>
// //             ))}
// //           </tbody>
...
// //       {/* --- Grid View --- */}
// //       {viewMode === 'grid' && playlists.length > 0 && (
...
// //       {/* --- List View --- */}
// //       {viewMode === 'list' && playlists.length > 0 && (
// //         <div className="space-y-4">
// //           {playlists.map(playlist => (
// //             <div key={playlist._id} className="border rounded-lg p-4 flex justify-between items-center">
// //               <div>
// //                 <h3 className="font-semibold text-lg">{playlist.name}</h3>
// //                 <p className="text-sm text-gray-600">{playlist.announcements.length} Tracks</p>
// //               </div>
